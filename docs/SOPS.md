...
- `docs/SOPS_SECRETS_CONFIG.md` - secrets handling and configuration sources
- `docs/SOPS_POST_PRODUCTION.md` - editing, audio mix, captions, and exports
- `docs/SOPS_AUDIO_MIXING.md` - mixing presets and board setup
- `docs/SOPS_REMOTE_EDITING.md` - file bridge and remote editing workflow
